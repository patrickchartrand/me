<template>
  <section id="hero" class="px-6 md:px-12 lg:px-24 mb-24 md:mb-40 min-h-[80vh] flex items-center">
    <div class="max-w-7xl mx-auto w-full">
      ...
      >
        Building component-driven
        <span class="highlight-offset">interfaces</span><br />
        that
      ...
      >
        <div class="max-w-xl">
          <p class="text-lg md:text-xl font-light leading-relaxed text-charcoal/80">
            ...
            structure, hierarchy, and clarity. Now I bridge design and code, building
        ...
        <div class="flex flex-col gap-2 text-right">
          ...
          <div class="flex items-center gap-2 mt-2 justify-end">
            <span class="w-2 h-2 rounded-full bg-available pulse-dot"></span>
...
.pulse-dot {
  ...
  box-shadow: 0 0 0 0 color-mix(in srgb, var(--color-available) 60%, transparent);
}
@keyframes pulse-ring {
  ...
  70% {
    box-shadow: 0 0 0 6px color-mix(in srgb, var(--color-available) 0%, transparent);
  }
  100% {
    box-shadow: 0 0 0 0 color-mix(in srgb, var(--color-available) 0%, transparent);
  }
}
</style>
